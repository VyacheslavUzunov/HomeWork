...
function Clock() {
    ...
    const stringTime = date.toTimeString() || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
    ...
    const stringMonth = Intl.DateTimeFormat("en-US").format(date)|| <br/> // пишут студенты
